...
#link s1<----->s4<------->s2
ovs-vsctl set port veth41 qos=@newqos5 --  \
--id=@newqos5 create qos type=linux-htb queues=0=@q0 --  \
--id=@q0 create queue other-config:max-rate=10000

ovs-vsctl set port veth42 qos=@newqos6 --  \
--id=@newqos6 create qos type=linux-htb queues=0=@q0 --  \
--id=@q0 create queue other-config:max-rate=10000

ovs-vsctl set port veth21 qos=@newqos7 --  \
--id=@newqos7 create qos type=linux-htb queues=0=@q0 --  \
--id=@q0 create queue other-config:max-rate=10000

ovs-vsctl set port veth22 qos=@newqos8 --  \
