...
ovs-ofctl -O openflow15 add-flow s4 in_port=1,dl_type=0x0800,nw_src=172.18.0.2,nw_dst=172.18.0.1,priority=10,idle_timeout=0,hard_timeout=0,actions=output:2,set_queue:0
ovs-ofctl -O openflow15 add-flow s3 in_port=2,dl_type=0x0800,nw_src=172.18.0.2,nw_dst=172.18.0.1,priority=10,idle_timeout=0,hard_timeout=0,actions=output:1,set_queue:0
