...
__attribute__((section("__versions"))) = {
	...
	{ 0x8afa9687, __VMLINUX_SYMBOL_STR(ovs_lisp_fill_metadata_dst) },
	{ 0xa8d3d356, __VMLINUX_SYMBOL_STR(rpl_lisp_xmit) },
	...
	{ 0x75b7ac0a, __VMLINUX_SYMBOL_STR(rpl_lisp_dev_create_fb) },
...
MODULE_INFO(srcversion, "BB4372478BC3CDF93C8806D");
