...
__attribute__((section("__versions"))) = {
	...
	{ 0xc1a5b311, __VMLINUX_SYMBOL_STR(ovs_stt_fill_metadata_dst) },
	{ 0xfd68f019, __VMLINUX_SYMBOL_STR(ovs_stt_xmit) },
	...
	{ 0xadbb561, __VMLINUX_SYMBOL_STR(ovs_stt_dev_create_fb) },
...
MODULE_INFO(srcversion, "0DB6398F12BF3B3805DF2AA");
