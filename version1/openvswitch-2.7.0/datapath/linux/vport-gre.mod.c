...
__attribute__((section("__versions"))) = {
	...
	{ 0x9a53d5cd, __VMLINUX_SYMBOL_STR(ovs_gre_fill_metadata_dst) },
	{ 0x19515894, __VMLINUX_SYMBOL_STR(rpl_gre_fb_xmit) },
	...
	{ 0x215f56eb, __VMLINUX_SYMBOL_STR(rpl_gretap_fb_dev_create) },
...
MODULE_INFO(srcversion, "86B73E651268D28AE2FAA2F");
